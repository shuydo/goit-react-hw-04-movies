...
const API_KEY = "2f8d6050c74d5f454a522d74a8cedbb8"; //max
const BASE_URL = "https://api.themoviedb.org/3";

const movieSearch = query => {
  return fetch(
    `${BASE_URL}/search/movie?api_key=${API_KEY}&language=ru-RU&query=${query}&page=1&`
...
export { movieSearch, getMovieById, getCastByMovieId, getReviewsByMovieId };
